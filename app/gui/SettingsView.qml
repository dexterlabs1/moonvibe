    ...
    Column {
        ...
        SettingsSection {
            ...
            Row {
                ...
                MvSlider {
                    ...
                    width: bitrateRow.width - (resetBitrateButton.visible ? resetBitrateButton.width + bitrateRow.spacing : 0)
                ...
                Button {
                    ...
                    // The gamepad sends Space here in UI navigation mode, which
                    // the button already handles; Return is for keyboard users.
        ...
        SettingsSection {
            ...
            MvTextField {
                ...
                // Inert until the user asks for it. Focusing a live text input
                // is what raises the Steam Deck's on-screen keyboard, and the
                // D-pad walks straight through this field on its way down the
                // page.
                activateToEdit: true
                ...
                onActivated : {
                    ...
                    if (StreamingPreferences.language !== new_language) {
                        ...
                        if (!StreamingPreferences.retranslate()) {
                            ToolTip.show(qsTr("You must restart Moonvibe for this change to take effect"), 5000)
                        }
                        else {
    ...
    Column {
            ...
            Row {
                ...
                MvCheckBox {
                    ...
                    ToolTip.text: qsTr("This enables the capture of system-wide keyboard shortcuts like Alt+Tab that would normally be handled by the client OS while streaming.") + "\n\n" +
                                  qsTr("NOTE: Certain keyboard shortcuts like Ctrl+Alt+Del on Windows cannot be intercepted by any application, including Moonvibe.")
                }
                ...
                AutoResizingComboBox {
                    ...
                    // The checkbox sizes itself from its label, so the combo
                    // takes whatever is left rather than pushing off the card.
                    maximumWidth: captureSysKeysRow.width - captureSysKeysCheck.width - captureSysKeysRow.spacing
        ...
        SettingsSection {
            ...
            MvCheckBox {
                ...
                ToolTip.timeout: 5000
                ToolTip.visible: hovered
                ToolTip.text: qsTr("Allows Moonvibe to capture gamepad inputs even if it's not the current window in focus")
            }
        }
