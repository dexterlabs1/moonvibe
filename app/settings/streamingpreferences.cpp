...
#define SER_STEAMGRIDDB_KEY "steamgriddbapikey"
...
void StreamingPreferences::reload()
{
    ...
    steamGridDbApiKey = settings.value(SER_STEAMGRIDDB_KEY, QString()).toString();
...
void StreamingPreferences::save()
{
    ...
    settings.setValue(SER_STEAMGRIDDB_KEY, steamGridDbApiKey);
